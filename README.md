...
Our pre-processed map prior datasets for nuScenes and Argoverse 2 are available for download [**here**](https://github.com/Ethan-Zheng136/UMPE/blob/main/README.md](https://huggingface.co/datasets/rethinking123/UMPE-Prior).
