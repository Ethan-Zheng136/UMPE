...
**Hao Sun**<sup>2</sup> · **Chao Ma**<sup>3</sup> · **Zhen Li**<sup>4</sup> · **Anqing Jiang**<sup>2†</sup> · [**Hao Zhao**](https://sites.google.com/view/fromandto/)<sup>1†</sup>
...
Our pre-processed map prior datasets for nuScenes and Argoverse 2 are available for download [**here**](https://huggingface.co/datasets/rethinking123/UMPE-Prior).
...
Our checkpoints for MapTRv2 and MapQR are available for download [**here**](https://drive.google.com/drive/folders/1fIEy1d49LLxIkWe7s38aljeJt2IsIYkC?dmr=1&ec=wgc-drive-%5Bmodule%5D-goto).
