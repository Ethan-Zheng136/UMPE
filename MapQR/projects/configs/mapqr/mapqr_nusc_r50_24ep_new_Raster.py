...
data_root = '/DATA_EDS2/zhenggt2407/MapQR/data/nuscenes/'
data_pkl_root = '/DATA_EDS2/zhenggt2407/MapQR/data/nuscenes/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_pkl_root + 'nuscenes_map_infos_temporal_train.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_pkl_root + 'nuscenes_map_infos_temporal_val.pkl',
        map_ann_file=data_pkl_root + 'nuscenes_map_anns_val.json',
