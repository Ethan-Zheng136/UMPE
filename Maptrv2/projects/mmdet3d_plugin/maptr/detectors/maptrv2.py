...
class MapTRv2(MVXTwoStageDetector):
    ...
    def __init__(self,
        ...
        if aligner is not None:
            self.hd_aligner = build_transformer_layer_sequence(aligner)
            self.sd_aligner = build_transformer_layer_sequence(aligner)
        else:
            self.hd_aligner = None
            self.sd_aligner = None
    ...
    def forward_test(
        ...
        sdmap = [sdmap] if sdmap is None else sdmap
        hdmap = [hdmap] if hdmap is None else hdmap
    ...
    def pred2result(self, bboxes, scores, labels, pts, attrs=None):
        ...
        return result_dict
    def simple_test_pts(self, x, lidar_feat, img_metas, prev_bev=None, satellite_img=None, SDRaster_img=None, vector_feats=None, rescale=False):
        """Test function"""
        outs = self.pts_bbox_head(
            x, 
            lidar_feat, 
    ...
    #     ax1.scatter(x, y, theta, c='r', marker='o')
    #     ax1.set_xlabel('X Translation')
    #     ax1.set_ylabel('Y Translation')
    #     ax1.set_zlabel('Rotation Theta')
    #     ax1.set_title('3D Transformation Parameters')

    #     ax2 = fig.add_subplot(232)
    #     ax2.scatter(range(len(theta)), theta, alpha=0.6)
    #     ax2.set_xlabel('Frame Index')
    #     ax2.set_ylabel('Theta')
    #     ax2.set_title('Rotation Theta Distribution')

    #     ax3 = fig.add_subplot(233)
    #     ax3.scatter(range(len(x)), x, alpha=0.6)
    #     ax3.set_xlabel('Frame Index')
    #     ax3.set_ylabel('X Translation')
    #     ax3.set_title('X Translation Distribution')

    #     ax4 = fig.add_subplot(234)
    #     ax4.scatter(range(len(y)), y, alpha=0.6)
    #     ax4.set_xlabel('Frame Index')
    #     ax4.set_ylabel('Y Translation')
    #     ax4.set_title('Y Translation Distribution')

    #     ax5 = fig.add_subplot(235)
    #     ax5.scatter(x, y, alpha=0.6)
    #     ax5.set_xlabel('X Translation')
    #     ax5.set_ylabel('Y Translation')
    #     ax5.set_title('XY Translation Distribution')

    #     ax6 = fig.add_subplot(236)
    #     ax6.hist(theta, bins=30, alpha=0.7, color='g', edgecolor='black')
    #     ax6.set_xlabel('Theta')
    #     ax6.set_ylabel('Frequency')
    #     ax6.set_title('Theta Histogram')
        
    #     plt.tight_layout()
    #     plt.savefig('/your/path/to/save.png')
    #     plt.show()
 
    #     print("\n=== Transformation Parameters Statistics ===")
    #     print(f"Theta - Mean: {np.mean(theta):.4f}, Std: {np.std(theta):.4f}")
