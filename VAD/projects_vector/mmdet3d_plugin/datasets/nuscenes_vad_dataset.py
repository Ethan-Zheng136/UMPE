...
class VADCustomNuScenesDataset(NuScenesDataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.vectorized_sdmap = pickle.load(open('/share/gha/shared/VAD_Vector/data/inter_nuscenes_trainval_sdmap_new.pkl', 'rb'))
        self.vectorized_hdmap = pickle.load(open('/share/gha/shared/VAD_Vector/data/interpolated_nuscenes_trainval_hdmap.pkl', 'rb'))
