...
class VAD(MVXTwoStageDetector):
    ...
    def forward_pts_train(self,
        ...
        outs = self.pts_bbox_head(pts_feats, img_metas, prev_bev,
                                  ego_his_trajs=ego_his_trajs, ego_lcf_feat=ego_lcf_feat, prior_tokens=prior_tokens)
        loss_inputs = [
    ...
    def forward_train(self,
        ...
        map_graph_feats = [hd_map_graph_feats, sd_map_graph_feats, hd_conf_token, sd_conf_token]
        losses = dict()
        losses_pts = self.forward_pts_train(img_feats, gt_bboxes_3d, gt_labels_3d,
                                            ...
                                            ego_lcf_feat=ego_lcf_feat, gt_attr_labels=gt_attr_labels, prior_tokens=map_graph_feats)
