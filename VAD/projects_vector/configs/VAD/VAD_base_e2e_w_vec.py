...
total_epochs = 60
load_from = '/share/gha/shared/VAD_prior/VAD_base.pth'
...
train_pipeline = [
    ...
    dict(type='CustomCollect3D',\
         keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'ego_his_trajs',
               'ego_fut_trajs', 'ego_fut_masks', 'ego_fut_cmd', 'ego_lcf_feat', 'gt_attr_labels', 'sdmap', 'hdmap'])
]
        ...
        transforms=[
            ...
            dict(type='CustomCollect3D',\
                 keys=['points', 'gt_bboxes_3d', 'gt_labels_3d', 'img', 'fut_valid_flag',
                       ...
                       'ego_lcf_feat', 'gt_attr_labels', 'sdmap', 'hdmap'])])
]
