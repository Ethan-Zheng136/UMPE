...
# from projects.mmdet3d_plugin.VAD.hooks.custom_hooks import AlphaScheduleHook
# from projects.mmdet3d_plugin.VAD.hooks.custom_hooks import FusionAlphaMonitorHook
