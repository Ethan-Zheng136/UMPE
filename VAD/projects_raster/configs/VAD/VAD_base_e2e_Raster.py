...
data = dict(
    ...
    val=dict(type=dataset_type,
            ...
            #  ann_file=data_root + 'vad_nuscenes_infos_temporal_val.pkl',
             ann_file='/share/gha/shared/vlm-planner/data/nuscenes/vad_nuscenes_infos_temporal_val.pkl',
...
load_from = '/share/gha/shared/vlm-planner/ckpt/epoch_40.pth'